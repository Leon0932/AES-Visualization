...
final class AESKeySchedTests: XCTestCase {
    ...
    func testKeyExp128() throws {
        ...
        XCTAssertEqual(keySched.getRoundKeys(),
                       roundKeys,
                       "KeyExpansion failed: Expected round keys do not match the actual round keys")

        XCTAssertEqual(keySched.getDetailedKeySchedule(),
                       roundofRoundKeys,
                       "Detailed RoundKeys failed: Expected detailed key schedule does not match the actual schedule")
    ...
    func testKeyExp192() throws {
        ...
        let roundofRoundKeys: [KeyExpansionRound] = [
            KeyExpansionRound(
                index: 6,
